                ...
                sql = "SELECT * from cliente";
                    ...
                    try {
                        ...
                        while(resultado.next()){
                            ...
                            cliente1.setPreco(resultado.getInt("preço"));
            ...
            case 3:
                ...
                try {
                    ...
                    while(resultado.next()){
                        ...
                        cliente2.setPreco(resultado.getInt("preço"));
                        cliente2.setMarca(resultado.getString("marca"));
                        cliente2.setCodigo(resultado.getString("código"));
                        cliente2.setCodigobarra(resultado.getInt("código de barra"));
